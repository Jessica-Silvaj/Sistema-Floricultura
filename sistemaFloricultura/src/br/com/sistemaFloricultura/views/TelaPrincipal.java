...
public class TelaPrincipal extends JFrame {
	...
	private void initComponents() {
		...
		lblNewLabel_7.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 19));
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(groupLayout.createSequentialGroup()
									...
									.addGap(18)
									.addComponent(textData, GroupLayout.PREFERRED_SIZE, 165, GroupLayout.PREFERRED_SIZE)
									.addGap(57))))
						.addGroup(groupLayout.createSequentialGroup()
							.addGap(4)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblNewLabel, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 32, Short.MAX_VALUE))
					.addGap(18)
		...
		//funcionarios.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.ALT_MASK));
	...
	protected void clicado() {
		// TODO Auto-generated method stub
        int sair = JOptionPane.showConfirmDialog(null, "Você realmente deseja sair do sistema?", "Atenção!", JOptionPane.YES_NO_OPTION);
